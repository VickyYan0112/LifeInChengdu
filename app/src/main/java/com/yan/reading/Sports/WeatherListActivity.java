...
public class WeatherListActivity  extends ListActivity implements Runnable{
    ...
    public void run() {
        ...
        try {
            ...
            for (int i = 10; i < tds.size(); i += 15) {
                Element td1 = tds.get(i);
                Element td2 = tds.get(i + 2);
                Element td3 = tds.get(i + 3);
                Element td4 = tds.get(i + 4);
                Element td5 = tds.get(i + 5);
                Element td6 = tds.get(i + 6);
                Element td7 = tds.get(i + 7);
                Log.i(TAG, "run: 城市" + td1.text());
                Log.i(TAG, "run: 白天天气状况" + td2.text());
                Log.i(TAG, "run: 白天风力方向" + td3.text());
                Log.i(TAG, "run: 白天最高温度" + td4.text());
                Log.i(TAG, "run: 夜间天气状况" + td5.text());
                Log.i(TAG, "run: 夜间风力方向" + td6.text());
                Log.i(TAG, "run: 夜间最高温度" + td7.text());
                ...
                retList.add(str1+"  "+str2+"  "+str3+"  "+str4+"  "+str5+"  "+str6+"  "+str7);
